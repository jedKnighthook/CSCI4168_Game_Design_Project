...
{   
	...
	private Color m_DeltaColor = new Color(0.05f,0.05f,0.05f,0.05f);		// the delta-color is basically the "speed / second" at which the current color should change
